...
/*
$Id: nusoap.php,v 1.1.1.1 2014/11/04 11:04:31 jigar Exp $
...
* @version  $Id: nusoap.php,v 1.1.1.1 2014/11/04 11:04:31 jigar Exp $
* @access   public
*/
class nusoap_base {
	/**
...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=180,$response_timeout=180){
...
//		  	}
//		}
		//Changed by IndaPoint Technologies Pvt. Ltd. (Jigar) on 19 July 2013 as per rchilli support email.
...
//		}
		...
		if ($cErr != '') {
			...
			/*$handle=fopen("/home/applivie/public_html/c/ErrorLogs/curlinfo.txt","w+");
			fwrite($handle,print_r(curl_getinfo($this->ch),1));
			fwrite($handle,"\r\n====================================\r\n");
			fclose($handle);*/
			//echo '<pre>';
